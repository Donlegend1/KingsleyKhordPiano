    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white shadow rounded-lg mt-6">
            ...
            {quiz.main_audio_path && (
                <div className="my-6 p-4 bg-red-50 border border-red-200 rounded-lg shadow-sm">
            ...
            <Modal
                ...
                title={`Question ${currentQuestion + 1} of ${
            ...
            >
                {!showResult ? (
                    <>
                        <div className="my-3">
                            ...
                            <div className="space-y-3 mb-6">
                                {getOptionsByCategory(quiz.category).map(
                                    (opt, i) => (
                                        <button
                                            key={i}
                                            onClick={() =>
                    ...
                    <div className="text-center">
                        ...
                        <p className="inline-block mt-2 px-4 py-1 rounded-full bg-green-100 text-green-700 font-semibold">
