...
const SpaceCard = ({ title, isAdmin, members }) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow hover:shadow-lg transition overflow-hidden">
      ...
      <div className="p-4">
        ...
        {/* View Button */}
        <button className="w-full border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition">
          View Space
        </button>
      </div>
    </div>
