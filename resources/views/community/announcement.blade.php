...
<div class="p-6">
    <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm p-10 text-center">
        ...
        <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-1.5">No announcements yet</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400">Kingsley's community announcements will show up here.</p>
    </div>
</div>
@endsection
