 ...
 <main class="flex-1 p-6">
   <header class="mb-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
    <div>
      ...
      <a href="/admin/email-campaign">Email Campaign</a>
      {{-- <a href="/admin/email-campaign/create" class="text-blue-600 hover:underline text-sm">Create</a> --}}
    </div>
  ...
  <div id="email-campaign-create"></div>
