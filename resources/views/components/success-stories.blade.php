<section class="py-20 px-4 bg-gray-50">
    <div class="max-w-3xl mx-auto text-center mb-12">
        <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">Member Success Story</h2>
        <p class="mt-3 text-gray-500 leading-relaxed">Hear directly from a member about their experience.</p>
    </div>
