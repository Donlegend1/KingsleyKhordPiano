  ...
  <a href="/member/my-library" class="block transition-shadow hover:shadow-md">
    <div class="min-h-[120px] h-full flex justify-between items-center gap-3 p-6 bg-[#F3F5F6] rounded-lg shadow-sm border">
      <div class="flex items-center space-x-4 min-w-0">
        <div class="w-12 h-12 flex items-center justify-center bg-[#E8EDF2] rounded-xl flex-shrink-0">
          <i class="fa fa-book-open text-[#435065] text-xl"></i>
        </div>
        <div class="min-w-0">
          <h4 class="font-semibold text-[#435065] text-[20px] font-sf truncate">My Library</h4>
          <p class="text-sm text-[#5E6779] mt-1 font-sf">Access all downloadable files and materials</p>
        </div>
      </div>
      <i class="fa fa-angle-right text-gray-400 text-lg flex-shrink-0"></i>
    </div>
  </a>
  ...
  <a href="https://discord.gg/gFXnRnaf5N" target="_blank" rel="noopener noreferrer" class="block transition-shadow hover:shadow-md">
    <div class="min-h-[120px] h-full flex justify-between items-center gap-3 p-6 bg-[#F3F5F6] rounded-lg shadow-sm border">
      <div class="flex items-center space-x-4 min-w-0">
        ...
        <div class="min-w-0">
          <h4 class="font-semibold text-[#435065] text-[20px] font-sf truncate">Community</h4>
