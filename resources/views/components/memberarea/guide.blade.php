<section class="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
  ...
  <div class="min-h-[120px] h-full flex justify-between items-center p-6 bg-[#F3F5F6] rounded-lg shadow-sm border">
    ...
    <div class="flex items-center space-x-4">
      <img src="/images/compass.png" alt="Compass Icon" class="w-12 h-12 object-contain" />
  ...
  <div class="min-h-[120px] h-full flex justify-between items-center p-6 bg-[#F3F5F6] rounded-lg shadow-sm border">
    ...
    <!-- Left Content -->
    <div class="flex items-center space-x-4">
      <img src="/images/music.png" alt="Compass Icon" class="w-12 h-12 object-contain" />
  ...
  <div class="min-h-[120px] h-full flex justify-between items-center p-6 bg-[#F3F5F6] rounded-lg shadow-sm border">
    ...
    <!-- Left Content -->
    <div class="flex items-center space-x-4">
      <img src="/images/community.svg" alt="Compass Icon" class="w-12 h-12 object-contain" />
