<section class="max-w-7xl mx-auto px-4 py-6 
  ...
  <!-- Card 4 (New) -->
  <a href="/member/piano-breakdowns" class="block transition-shadow hover:shadow-md">
    <div class="min-h-[120px] h-full flex justify-between items-center p-6 bg-[#F3F5F6] rounded-lg shadow-sm border">
      <div class="flex items-center space-x-4">
        <img src="/images/breakdown.png" class="w-12 h-12 object-contain" />
        <div>
          <h4 class="font-semibold text-[#435065] text-[20px] font-sf">Piano Coaching</h4>
          <p class="text-sm text-[#5E6779] mt-1 font-sf">As a premium member, you’re eligible for one free 1-on-1 session every month</p>
        </div>
      </div>
      <i class="fa fa-angle-right text-gray-400 text-lg"></i>
    </div>
