<section class="mx-auto px-4 py-12 max-w-7xl">
  <div class="flex flex-col md:flex-row items-stretch gap-8">
    ...
    <!-- Form (70%) -->
    <div class="w-full md:w-[70%] bg-white p-6 rounded-lg shadow-lg">
      <div>
        <h2 class="text-3xl font-bold text-gray-800 mb-2">Get in Touch with us</h2>
        <p class="text-sm text-[#667085] mb-4">Our friendly team would love to hear from you.</p>
      </div>
    ...
    <!-- Image (30%) -->
    <div class="w-full md:w-[30%] hidden md:block">
