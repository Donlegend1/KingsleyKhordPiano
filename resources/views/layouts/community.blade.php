...
@php
    ...
    $topLinks = [
        ...
        ['url' => 'https://kingsleykhordpiano.com/shop', 'label' => 'Shop', 'external' => true, 'icon' => 'M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z M3 6h18 M16 10a4 4 0 0 1-8 0'],
    ];
@endphp
                            ...
                            <div class="relative" @click.outside="openSettings = false">
                                ...
                                <div x-show="openSettings" x-cloak x-transition
                                    ...
                                    <label class="flex items-center gap-2 px-2 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/60 cursor-pointer">
                                        <input type="radio" name="notifPrefCommunity" value="push" x-model="notifPref" :disabled="saving" @change="setPref('push')" class="text-indigo-600 focus:ring-indigo-400">
                                        <span class="text-sm text-gray-700 dark:text-gray-200">Push notifications</span>
                                    </label>
                                    <label class="flex items-center gap-2 px-2 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/60 cursor-pointer">
                                        <input type="radio" name="notifPrefCommunity" value="email" x-model="notifPref" :disabled="saving" @change="setPref('email')" class="text-indigo-600 focus:ring-indigo-400">
                                        <span class="text-sm text-gray-700 dark:text-gray-200">Email notifications</span>
                                    </label>
                                    <label class="flex items-center gap-2 px-2 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/60 cursor-pointer">
                                        <input type="radio" name="notifPrefCommunity" value="disabled" x-model="notifPref" :disabled="saving" @change="setPref('disabled')" class="text-indigo-600 focus:ring-indigo-400">
