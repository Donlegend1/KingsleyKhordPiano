...
<section class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 px-4">
  <div class="max-w-7xl mx-auto space-y-1">
    ...
    @if ($series)
    <div class="mb-4">
        <a href="{{ route('extra.courses') }}" class="text-blue-500 hover:underline flex items-center gap-2">
            <i class="fa fa-arrow-left text-sm"></i> 
            <span class="font-medium">Back to All Extra Courses</span>
        </a>
  ...
  >
    ...
    <div class="block lg:hidden mb-6">
      <div class="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-4 shadow-sm">
        <label for="extracourse-mobile-filter" class="mb-2 block text-xs font-bold uppercase tracking-[0.22em] text-slate-500">
          Filter Lessons
        </label>
        <div class="relative">
          <select
            id="extracourse-mobile-filter"
            x-model="activeTab"
