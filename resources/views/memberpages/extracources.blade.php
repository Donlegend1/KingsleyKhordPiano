        ...
        return {
            ...
            init() {
                ...
                this.$refs.resultsContainer.addEventListener('click', (e) => {
                    ...
                    // different ?page=). Course/lesson links go to a
                    // different route entirely and must do a normal full
                    // navigation — otherwise that page's full HTML (header,
                    // nav, etc.) gets stuffed into this container instead of
                    // the browser actually navigating there.
