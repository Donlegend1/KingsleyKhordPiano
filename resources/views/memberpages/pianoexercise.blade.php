...
<section class="bg-gray-100 py-10">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
    <div class="flex flex-col lg:flex-row gap-8">
      ...
      <div class="flex-1">
        <!-- Tabs -->
        <div class="flex flex-wrap gap-3 border-b pb-2 mb-8">
          @php
            $isAll = is_null($level);
      ...
      <!-- Sidebar -->
        <aside class="w-full lg:w-72 bg-white p-6 rounded-xl shadow-md h-fit mt-14 lg:mt-[72px]">
          <div>
            ...
            <div class="space-y-2">
              <a href="{{ route('piano.exercise', array_filter(['level' => $level])) }}"
                class="flex items-center gap-2 px-4 py-2 rounded-md border border-gray-200 text-sm transition hover:bg-blue-50 {{ is_null($skillLevel) ? 'bg-blue-50 border-blue-300 text-blue-600 font-medium' : 'text-gray-700' }}">
              ...
              @foreach ($skillLevels as $sl)
                ...
                @endphp
                <a href="{{ $url }}"
                  class="flex items-center gap-2 px-4 py-2 rounded-md border border-gray-200 text-sm transition hover:bg-blue-50 {{ $active ? 'bg-blue-50 border-blue-300 text-blue-600 font-medium' : 'text-gray-700' }}">
